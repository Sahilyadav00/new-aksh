...
export const metadata = {
  title:
    "Contact Aksh Digital | Digital Marketing & Web Development Agency Jaipur",
  description:
    "Contact Aksh Digital for SEO, Google Ads, web development, and performance marketing. Serving businesses in Jaipur, Delhi, Mumbai, Bangalore, and global markets (USA, UK).",
  alternates: {
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative pb-20 lg:pb-28 pt-10 flex overflow-hidden bg-slate-50 border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-600 text-[15px] sm:text-base md:text-lg leading-relaxed">
              Whether you are looking for a reliable digital marketing company
              in Jaipur, need an experienced performance marketing agency India
              to scale ad revenue, or require offshore development support as a
              digital marketing agency USA partner, our team is ready to help
              you scale.
            </p>
          </div>
        </div>
        <div className="hidden lg:flex items-end pr-8">
          <Image
            src="/assets/images/home/icon-01.webp"
            alt="Contact Us"
            width={400}
            height={400}
          />
            ...
            <div className="lg:col-span-5 space-y-10">
              <div>
                ...
                <p className="text-gray-500 text-[15px] leading-relaxed">
                  We are headquartered in Jaipur and serve clients across India,
                  USA, UK, and global markets.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {contactInfo.map((info, idx) => (
                  <div
                    key={idx}
                    className="bg-slate-50 rounded-xl p-5 border border-slate-100 hover:shadow-md transition-shadow duration-300"
                  >
                    <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                      <info.icon className="w-5 h-5" />
                    </div>
                    <h3 className="font-bold text-[#14183e] text-sm mb-1">
                      {info.title}
                    </h3>
              ...
              <div className="bg-[#14183e] rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                <p className="text-white/70 text-sm mb-5">
                  Our growth roadmap audit is completely custom-made by Aksh
                  Digital experts, pinpointing direct opportunities to double
                  your revenue flow.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {processSteps.map(({ step, title, desc }) => (
              <div
                key={step}
                className="relative flex flex-col p-8 rounded-2xl border border-slate-100 bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] hover:shadow-xl transition-all duration-300"
              >
                <span className="text-[48px] font-black text-primary/10 leading-none mb-4 select-none">
                  {step}
                </span>
                <h3 className="text-lg font-semibold text-[#14183e] mb-3">
                  {title}
                </h3>
