      ...
      <section className="relative overflow-hidden bg-[#0f1535] py-20 sm:py-28 px-4 sm:px-6">
        ...
        <div className="relative z-10 mx-auto max-w-5xl">
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-400">
            ...
            <span>
              Serving Tech Startups, Pharma Leaders & Enterprises Across
              Hyderabad & Telangana
            </span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0f1535] leading-tight mb-6">
                Turning Cyberabad&apos;s Search Demand into Predictable Inbound
                Growth
              </h2>
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
              ...
              engineered to systematically elevate your Hyderabad business to
              Page 1.
            </p>
          </div>
