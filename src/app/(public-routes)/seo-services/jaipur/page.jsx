...
export const metadata = {
  title: "SEO Services in Jaipur | Best SEO Company Jaipur — Aksh Digital",
  description:
    "Aksh Digital is the leading SEO company in Jaipur. We help Jaipur businesses rank on Google's first page with proven SEO strategies, local SEO, and content marketing.",
};

const cityData = {
  city: "Jaipur",
  state: "Rajasthan",
  tagline: "The Pink City's #1 SEO Agency",
  description:
    "From Sindhi Camp to Malviya Nagar, we help Jaipur businesses dominate local and national search results. Our Jaipur-based SEO team understands the local market, competition, and customer behaviour that drives growth in the Pink City.",
  localFacts: [
    "Top-ranked results for 50+ Jaipur-based businesses",
    "Deep knowledge of Jaipur's business landscape and competition",
    "Local citation building across Jaipur business directories",
    "Google Business Profile optimisation for Jaipur searches",
  ],
  nearbyAreas: ["Malviya Nagar", "Vaishali Nagar", "Mansarovar", "Tonk Road", "Sikar Road", "MI Road"],
  faqs: [
    { q: "How long does SEO take to show results in Jaipur?", a: "For most Jaipur businesses, you can expect to see measurable improvements in 3–6 months. Competitive niches may take 6–9 months for first-page rankings." },
    { q: "Do you offer local SEO for Jaipur businesses?", a: "Absolutely. We specialise in local SEO for Jaipur — including Google Business Profile optimisation, local citations, and area-specific content targeting." },
    { q: "Can you help my Jaipur shop appear in 'near me' searches?", a: "Yes! We optimise your online presence specifically for 'near me' and location-based searches across Jaipur and surrounding areas." },
    { q: "What industries do you serve in Jaipur?", a: "We serve all industries in Jaipur including hospitality, jewellery, textiles, real estate, education, healthcare, and e-commerce businesses." },
  ],
};

const services = [
  { icon: Search, title: "Local SEO Jaipur", desc: "Rank for 'near me' and city-specific searches that bring foot traffic and local leads." },
  { icon: Globe, title: "Technical SEO", desc: "Fix crawl errors, improve site speed, and ensure your Jaipur website is fully indexable." },
  { icon: BarChart3, title: "Content Marketing", desc: "Jaipur-relevant blog content and landing pages that attract local search traffic." },
  { icon: TrendingUp, title: "Link Building", desc: "High-authority backlinks from Jaipur and India-based sources to boost your domain authority." },
  { icon: Users, title: "Google Business Profile", desc: "Complete GMB optimisation to dominate the Jaipur 'map pack' results." },
  { icon: Star, title: "Reputation Management", desc: "Grow and manage online reviews to build trust with Jaipur's local audience." },
];
    ...
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden bg-[#0f1535] py-20 sm:py-24 px-4 sm:px-6">
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-sm font-semibold text-[#f6ac55] uppercase tracking-wider">
              SEO Services in {cityData.city}
            </span>
          </div>
      ...
      <section className="bg-[#d25c41] py-10 px-4 sm:px-6">
        <div className="mx-auto max-w-5xl grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
          {[
            { num: "50+", label: `${cityData.city} Clients Served` },
            { num: "85%", label: "First-Page Rankings" },
            { num: "3x", label: "Avg. Traffic Growth" },
            { num: "6 Months", label: "To Significant Results" },
          ].map(({ num, label }) => (
            <div key={label}>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#14183e] mb-4">
              Our SEO Services in {cityData.city}
            </h2>
            <p className="text-slate-600 max-w-xl mx-auto">
              A complete suite of local and national SEO services tailored for {cityData.city} businesses.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold text-[#14183e] mb-4">
              Why Local SEO Matters for {cityData.city} Businesses
            </h2>
            <p className="text-slate-600 text-base leading-relaxed mb-6">
              Over 76% of people who search for something nearby on their phone visit a related business within a day.
              If your {cityData.city} business isn't showing up in local searches, you're losing customers to competitors who are.
            </p>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-[#fafaf9]">
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#14183e]">
              FAQs — SEO in {cityData.city}
            </h2>
          </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#d25c41] to-[#b84d35] py-16 px-4 sm:px-6 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            Ready to Rank #1 in {cityData.city}?
          </h2>
          <p className="text-white/80 mb-8">
            Get a free SEO audit and a personalised strategy for your {cityData.city} business today.
          </p>
