  ...
  return (
    <>
      <section className="max-w-384 mx-auto w-full bg-white shadow-[0_12px_40px_-15px_rgba(0,0,0,0.03)] px-3 sm:px-6 md:px-8 py-6 sm:py-12 relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl">
            {/* Badge Pill */}
            <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full border border-primary/25 bg-primary/5 text-primary text-sm  font-semibold tracking-wide hover:bg-primary/10 transition-colors duration-300">
              <span>Crafting Your Ideas!</span>
              <ArrowRight className="w-3.5 h-3.5" strokeWidth={2.5} />
            </div>

            {/* Heading */}
            <h1 className="text-[36px] sm:text-[48px] md:text-[56px] lg:text-[62px] font-semibold text-slate-900 leading-[1.15] mt-6 mb-6 tracking-tight">
              Software & Digital <br className="hidden sm:inline" />
              Marketing Company
            </h1>

            {/* Description */}
            <p className="text-slate-600 text-[15px] sm:text-[16px] md:text-[17px] leading-relaxed mb-8 max-w-xl">
      ...
      <section className="relative w-full overflow-hidden bg-[#faf9f7] px-3 sm:px-6 md:px-8 pt-10 pb-16 sm:pt-14 sm:pb-20 md:pt-16 md:pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
            ...
            <div className="relative mx-auto w-full max-w-lg lg:max-w-none">
              ...
              {/* <div className="absolute -left-1 top-6 z-20 rounded-xl bg-white px-4 py-3 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:left-2 sm:top-8 sm:px-5 sm:py-4">
              ...
              {/* <div className="absolute bottom-6 right-2 z-20 w-[min(100%,11.5rem)] rounded-xl bg-white p-3 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:right-4 sm:w-44 sm:p-4">
                <p className="text-xs text-slate-500">Sales trend</p>
                <p className="mt-0.5 text-2xl font-bold text-slate-900">68%</p>
                <svg
                  viewBox="0 0 120 40"
                ...
                >
                  <polyline
                    ...
                    points="0,32 25,28 50,22 75,18 100,10 120,6"
                  />
                  <polyline
                    fill="none"
                    stroke="#fbbf24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    points="0,36 25,30 50,26 75,20 100,16 120,12"
                  />
                </svg>
              </div> */}
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                <h2 className="mt-4 text-[28px] font-bold leading-tight text-[#1a2744] sm:text-[34px] md:text-[38px] lg:text-[42px]">
                ...
                <ul className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6">
                ...
                <p className="mt-8 flex gap-2 text-[15px] font-bold italic text-[#1e3a6e] sm:text-base">
                  <Quote
        ...
        <div className="pointer-events-none absolute -bottom-2 right-0 z-20 w-[100px] sm:w-[140px] md:w-[180px] lg:w-[220px] xl:w-[240px]">
          <Image
      ...
      <section className="relative w-full overflow-x-hidden bg-white px-3 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        <div className="relative z-10 mx-auto max-w-6xl text-center">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-100 px-4 py-1.5 text-sm font-semibold text-violet-800">
            Our Blog
            <span aria-hidden>🔥</span>
          </span>

          <h2 className="mt-5 text-[26px] font-semibold leading-tight text-[#14183e] sm:text-[32px] md:text-[36px]">
        ...
        <div className="relative z-10 mx-auto mt-10 grid max-w-6xl grid-cols-1 gap-6 sm:mt-12 sm:grid-cols-2 sm:gap-7 lg:grid-cols-3 lg:gap-8">
          {blogPosts.map(({ title, category, date, image }) => (
            <article
              key={title}
              className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-[0_4px_24px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)]"
            >
